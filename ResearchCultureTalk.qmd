...
-   Hard because we typically need our teachers. Long term planning.\
     
-   Attract [**guest professors**]{style="color:#bf9d6c;"} to give a course, seminars and for discussing research. Sabbaticals. Funding.\
     
-   Informal shorter (day-week-month) exchange of staff between universities.\
     
...
-   Scholarships and travel support.\
      [URA-agreement](https://www.arbetsgivarverket.se/arbetsgivarguiden/personal-utomlands/utlandsstationering-med-ura/) is ideal, but costly.
-   Easy and cheap guest housing on campus would do wonders.

## Learning together - journal clubs etc

-   Learning together breaks (prestige) barriers and opens up for collaborations.\
     
...
-   [**Micro-seminars**]{style="color:#bf9d6c;"}\
     
-   Small research groups with PhD students, post doc and senior researcher.
...
![](Images/techtalks.png){fig-align="center" width="30%"}
...
-   "Black box" money for grant writing, guests etc is really useful. <br><br><br>  Thanks for listening! <br>I would love to hear [**your thoughts and ideas**]{style="color:#bf9d6c;"} now!
